...
def brighten(image, factor):
    ...
    new_im.array = image.array * factor # You can vectorize this array faster than the above one.
...
# for eg. , k=3 would be this kernel:
# [1/9 1/9 1/9]
# [1/9 1/9 1/9]
# [1/9 1/9 1/9]
...
if __name__ == '__main__':
    ...
    #brightening
    brightened_im = brighten(city, 50)
    brightened_im.write_image('brightened.png')

    # darkening
    darkened_im = brighten(city, 0.3)
    ...
    # # decrease contrast
    decr_contrast = adjust_contrast(city, 0.5, 0.5)
